    ...
    <Container className="register-container d-flex align-items-center justify-content-center min-vh-100">
      <div className="register-card shadow p-4 rounded">
        <div className="text-center mb-4">
          <img src={logo} alt="Logo" width={70} className="mb-3 logo-glow" />
          <h2 className="fw-bold text-white">Create Account</h2>
          <p className="text-muted">Join Magic Stream and explore endless movies.</p>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Button
            variant="primary"
            type="submit"
            className="w-100 mb-2 register-btn"
            disabled={loading}
          >
            {loading ? (
              <>
          ...
          <p className="text-center mt-3 text-muted">
            ...
            <Link to="/login" className="text-decoration-none text-accent">
              Log in
            </Link>
          </p>
        </Form>
